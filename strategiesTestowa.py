    ...
    def next(self):
        ...
        #wygładzanie
            ...
            if self.ticket is not None:
                self.carry1 = (((self.datas[2].close[0] * self.vol1 * self.datas[0].close[0]))/(1/self.datas[4].close[0]))
              ...
              #      self.Pair2Exposure = (self.sellValue - (self.cena2 * self.vol2open))/cenka2
                    ...
                    self.pair1_carry.append(((self.datas[2].close[0] * self.vol1 * self.datas[0].close[0]))/(1/self.datas[4].close[0]))
                ...
                self.test_daily_change.append(abs((((self.vol1open * (self.datas[0].close[0] - self.datas[0].close[-1]))))/(1/self.datas[4].close[0]))
                ...
                self.test_daily_change_summary.append((((self.vol1open * (self.datas[0].close[0] - self.datas[0].close[-1]))))/(1/self.datas[4].close[0]))
                + abs((((self.vol2open * (self.datas[1].close[0] - self.datas[1].close[-1]))))/self.datas[5].close[0])
##########################################33
